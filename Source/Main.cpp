...
BOOST_PYTHON_MODULE(SynthPy)
{
    ...
    class_<RenderEngineWrapper>("Host", init<int, int, int>())
        ...
        .def("get_parameter_len", &RenderEngineWrapper::wrapperGetPluginParameterSize)
        .def("get_parameter_descriptions", &RenderEngineWrapper::wrapperGetPluginParametersDescription)
